...
int main(int argc, char* argv[]) {
    ...
    #define TEST_TO_RUN 0
        ...
        test1351();
    #elif TEST_TO_RUN == 1390
        test1390();
    #elif TEST_TO_RUN == 1431
        test1431();
    #elif TEST_TO_RUN == 1456
        test1456();
    #elif TEST_TO_RUN == 1493
        test1493();
    #elif TEST_TO_RUN == 1523
        test1523();
    #elif TEST_TO_RUN == 1657
        test1657();
        ...
        test2211();
    #elif TEST_TO_RUN == 2215
        test2215();
    #elif TEST_TO_RUN == 2352
        test2352();
    #elif TEST_TO_RUN == 2390
        test2390();
    #elif TEST_TO_RUN == 3090
        test3090();
